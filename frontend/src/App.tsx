        ...
        <section className="left-column">
            ...
            <div className="dkt-grid">
              ...
              >
                <div className="concept-header">
                  ...
                  <span className="concept-pct" style={{ color: '#FFD1DC' }}>
                ...
                <div className="decay-risk-bar">
                  <span>Retention:</span>
                  <span className="decay-danger" style={{ color: '#FFD1DC' }}>
          ...
          <div className="criticals-panel">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <span style={{ fontSize: '11.5px', color: '#FFD1DC', fontWeight: 700 }}>
            ...
            <div className="critical-item">
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '9px' }}>
                <span style={{ color: '#FFD1DC', fontSize: '16px' }}>💡</span>
                <div>
          ...
          <div className="modal-body">
            ...
            {quizFeedback && (
              <div
                ...
                style={{
                  display: 'block',
                  background: quizFeedback.isCorrect ? 'var(--color-math-subtle)' : 'rgba(255, 209, 220, 0.15)',
                  color: quizFeedback.isCorrect ? 'var(--color-math)' : '#FFD1DC',
                }}
              >
                {quizFeedback.text}
              </div>
          ...
          <div className="modal-body" style={{ alignItems: 'center', padding: '32px 22px' }}>
            ...
            <div
              style={{
                ...
                border: '1.5px solid rgba(255, 209, 220, 0.3)',
                color: '#ffffff',
                borderRadius: '50%',
                display: 'flex',
                alignItems: 'center',
                ...
                marginBottom: '12px',
                boxShadow: '0 4px 20px rgba(255, 209, 220, 0.2)',
              }}
            >
